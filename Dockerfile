...
# Install anidl
RUN wget https://github.com/anidl/multi-downloader-nx/releases/download/v5.6.8/multi-downloader-nx-linux-x64-cli.7z -O /tmp/multi-downloader-nx-linux-cli.7z && \
